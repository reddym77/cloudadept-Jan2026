...
const ServicePageLayout: React.FC<ServicePageLayoutProps> = ({ title, description, children, seoTitle, seoDescription, seoUrl }) => {
  return (
    <div className="animate-fadeIn bg-white transition-colors duration-300">
      <SEO
        title={seoTitle || `${title} | CloudAdept Systems`}
        description={seoDescription || description}
        url={seoUrl || "https://www.cloudadeptsystems.com"}
      />
      {/* Hero Section */}
